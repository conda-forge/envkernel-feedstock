...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/envkernel-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14026&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/envkernel-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `envkernel` can be installed with:

```
conda install envkernel
```

It is possible to list all of the versions of `envkernel` available on your platform with:
